// 0ae019c53a08a0cb21610e5fb8795524
let searchHistory = [];
const weatherAPIRootUrl = "https://api.openweathermap.org";
const weatherApiKey = "0ae019c53a08a0cb21610e5fb8795524";
...
var searchHistoryClear = document.querySelector("#clearHistoryBtn")

// time zone plugins to day.js
...
// function to output search history from local storage
...
function renderForecastCard(forecast, timezone) {
  ...
  function handleSearchHistoryClear(e){
    searchHistory=[]
    localStorage.setItem("search-history", JSON.stringify(searchHistory))
  }
  ...
  searchHistoryClear.addEventListener('click', handleSearchHistoryClear)